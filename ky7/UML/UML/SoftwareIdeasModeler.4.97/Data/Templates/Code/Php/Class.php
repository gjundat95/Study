...
<%==SIM:EndFor==%> */
<%==SIM:If:Element.IsAbstract==%> abstract<%==SIM:EndIf==%> class <%==SIM:Element.Name==%><%==SIM:If:Element.HasSuperClass==%> extends <%==SIM:Element.SuperClass.Name==%><%==SIM:EndIf==%>
{
...
<%==SIM:ForEach:Element.Operations==%>
    ...
    <%==SIM:EndFor==%> */
    <%==SIM:Operation.Visibility==%><%==SIM:If:Attribute.IsAbstract==%> abstract<%==SIM:EndIf==%> function <%==SIM:Operation.Name==%> (<%==SIM:ForEach:Operation.Parameters==%>/*<%==SIM:Parameter.Type==%>*/ $<%==SIM:Parameter.Name==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%>)<%==SIM:If:Attribute.IsAbstract==%>;<%==SIM:EndIf==%><%==SIM:IfNot:Attribute.IsAbstract==%>        
    {
